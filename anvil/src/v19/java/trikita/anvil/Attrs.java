 ...
 */
public final class Attrs extends CommonAttrs {
  ...
  public static DSL.ViewClassResult mediaRouteButton() {
    return DSL.v(MediaRouteButton.class);
  }

  public static Void mediaRouteButton(Renderable r) {
    return DSL.v(MediaRouteButton.class, r);
  }
  ...
  public static DSL.ViewClassResult textClock() {
    return DSL.v(TextClock.class);
  }

  public static Void textClock(Renderable r) {
    return DSL.v(TextClock.class, r);
  }
  ...
  private static final class AccessibilityLiveRegionFunc8567756a implements AttrFunc<Integer> {
  ...
  private static final class BackgroundFuncfb47464a implements AttrFunc<Drawable> {
  ...
  private static final class ClipBoundsFunc1cc93e48 implements AttrFunc<Rect> {
  ...
  private static final class CropToPaddingFunc148d6054 implements AttrFunc<Boolean> {
  ...
  private static final class DateTextAppearanceFunc8567756a implements AttrFunc<Integer> {
  ...
  private static final class ExtendedSettingsClickListenerFunc79a13a5e implements AttrFunc<View.OnClickListener> {
  ...
  private static final class FindListenerFunc28f7f5ef implements AttrFunc<WebView.FindListener> {
  ...
  private static final class FocusedMonthDateColorFunc8567756a implements AttrFunc<Integer> {
  ...
  private static final class Format12HourFuncc0af808b implements AttrFunc<CharSequence> {
  ...
  private static final class Format24HourFuncc0af808b implements AttrFunc<CharSequence> {
  ...
  private static final class HasTransientStateFunc148d6054 implements AttrFunc<Boolean> {
  ...
  private static final class ImageAlphaFunc8567756a implements AttrFunc<Integer> {
  ...
  private static final class ImportantForAccessibilityFunc8567756a implements AttrFunc<Integer> {
  ...
  private static final class LabelForFunc8567756a implements AttrFunc<Integer> {
  ...
  private static final class LayerPaintFunc7c40a07a implements AttrFunc<Paint> {
  ...
  private static final class LayoutDirectionFunc8567756a implements AttrFunc<Integer> {
  ...
  private static final class LayoutInflaterFunc3f91d1f implements AttrFunc<LayoutInflater> {
  ...
  private static final class LayoutModeFunc8567756a implements AttrFunc<Integer> {
  ...
  private static final class OnDismissFuncfea72fd6 implements AttrFunc<AutoCompleteTextView.OnDismissListener> {
  ...
  private static final class OnInfoFuncfc58c853 implements AttrFunc<MediaPlayer.OnInfoListener> {
  ...
  private static final class PopupBackgroundDrawableFuncfb47464a implements AttrFunc<Drawable> {
  ...
  private static final class PopupBackgroundResourceFunc8567756a implements AttrFunc<Integer> {
  ...
  private static final class RouteTypesFunc8567756a implements AttrFunc<Integer> {
  ...
  private static final class ScrollBarDefaultDelayBeforeFadeFunc8567756a implements AttrFunc<Integer> {
  ...
  private static final class ScrollBarFadeDurationFunc8567756a implements AttrFunc<Integer> {
  ...
  private static final class ScrollBarSizeFunc8567756a implements AttrFunc<Integer> {
  ...
  private static final class SecureFunc148d6054 implements AttrFunc<Boolean> {
  ...
  private static final class SelectedDateVerticalBarFuncfb47464a implements AttrFunc<Drawable> {
  ...
  private static final class SelectedDateVerticalBarFunc8567756a implements AttrFunc<Integer> {
  ...
  private static final class SelectedWeekBackgroundColorFunc8567756a implements AttrFunc<Integer> {
  ...
  private static final class ShownWeekCountFunc8567756a implements AttrFunc<Integer> {
  ...
  private static final class SurfaceTextureFuncc2f30b12 implements AttrFunc<SurfaceTexture> {
  ...
  private static final class SwitchMinWidthFunc8567756a implements AttrFunc<Integer> {
  ...
  private static final class SwitchPaddingFunc8567756a implements AttrFunc<Integer> {
  ...
  private static final class TextAlignmentFunc8567756a implements AttrFunc<Integer> {
  ...
  private static final class TextDirectionFunc8567756a implements AttrFunc<Integer> {
  ...
  private static final class TextLocaleFuncba8c481a implements AttrFunc<Locale> {
  ...
  private static final class ThumbDrawableFuncfb47464a implements AttrFunc<Drawable> {
  ...
  private static final class ThumbResourceFunc8567756a implements AttrFunc<Integer> {
  ...
  private static final class ThumbTextPaddingFunc8567756a implements AttrFunc<Integer> {
  ...
  private static final class TimeZoneFunc473e3665 implements AttrFunc<String> {
  ...
  private static final class TrackDrawableFuncfb47464a implements AttrFunc<Drawable> {
  ...
  private static final class TrackResourceFunc8567756a implements AttrFunc<Integer> {
  ...
  private static final class UnfocusedMonthDateColorFunc8567756a implements AttrFunc<Integer> {
  ...
  private static final class WebContentsDebuggingEnabledFunc148d6054 implements AttrFunc<Boolean> {
  ...
  private static final class WeekDayTextAppearanceFunc8567756a implements AttrFunc<Integer> {
  ...
  private static final class WeekNumberColorFunc8567756a implements AttrFunc<Integer> {
  ...
  private static final class WeekSeparatorLineColorFunc8567756a implements AttrFunc<Integer> {
