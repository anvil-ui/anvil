...
public class Props4 {
  ...
  public static Node adapter(final android.widget.Adapter val) { 
    return new Node(new SimpleSetter(val) {
      public void set(View v) {
        ...
        //if (v instanceof android.widget.AutoCompleteTextView)
          //((android.widget.AutoCompleteTextView) v).setAdapter(val);
        //if (v instanceof android.widget.ExpandableListView)
  ...
  public static Node staticTransformationsEnabled(final boolean val) { 
    return new Node(new SimpleSetter(val) {
      public void set(View v) {
        //if (v instanceof android.view.ViewGroup)
          //((android.view.ViewGroup) v).setStaticTransformationsEnabled(val);
      }
    });
  }
  ...
  public static Node childrenDrawnWithCacheEnabled(final boolean val) { 
    return new Node(new SimpleSetter(val) {
      public void set(View v) {
        //if (v instanceof android.view.ViewGroup)
          //((android.view.ViewGroup) v).setChildrenDrawnWithCacheEnabled(val);
      }
    });
  }
  ...
  public static Node childrenDrawingCacheEnabled(final boolean val) { 
    return new Node(new SimpleSetter(val) {
      public void set(View v) {
        //if (v instanceof android.view.ViewGroup)
          //((android.view.ViewGroup) v).setChildrenDrawingCacheEnabled(val);
      }
    });
  }
