 ...
 * This file has been generated by {@code gradle generateSDKAppcompatV7DSL}.
 * It contains views and their setters from the library appcompat-v7.
 * Please, don't edit it manually unless for debugging.
 */
public final class DSL extends BaseDSL {
  public static DSL.ViewClassResult expandedMenuView() {
  ...
  public static DSL.ViewClassResult listMenuItemView() {
  ...
  public static DSL.ViewClassResult actionBarContainer() {
  ...
  public static DSL.ViewClassResult actionMenuView() {
  ...
  public static DSL.ViewClassResult activityChooserView() {
  ...
  public static DSL.ViewClassResult appCompatCheckedTextView() {
  ...
  public static DSL.ViewClassResult appCompatRatingBar() {
  ...
  public static DSL.ViewClassResult appCompatSeekBar() {
  ...
  public static DSL.ViewClassResult buttonBarLayout() {
  ...
  public static DSL.ViewClassResult contentFrameLayout() {
  ...
  public static DSL.ViewClassResult dialogTitle() {
  ...
  public static DSL.ViewClassResult fitWindowsFrameLayout() {
  ...
  public static DSL.ViewClassResult fitWindowsLinearLayout() {
  ...
  public static DSL.ViewClassResult linearLayoutCompat() {
  ...
  public static DSL.ViewClassResult listViewCompat() {
  ...
  public static DSL.ViewClassResult switchCompat() {
  ...
  public static DSL.ViewClassResult toolbar() {
  ...
  public static DSL.ViewClassResult viewStubCompat() {
  ...
  public static Void activityChooserModel(ActivityChooserModel arg) {
    return DSL.attr(ActivityChooserModelFunc5cb66d58.instance, arg);
  }

  public static Void allowStacking(boolean arg) {
    return DSL.attr(AllowStackingFunc148d6054.instance, arg);
  }

  public static Void attachListener(ContentFrameLayout.OnAttachListener arg) {
    return DSL.attr(AttachListenerFunc3ca76dcd.instance, arg);
  }
  ...
  public static Void checkable(boolean arg) {
    return DSL.attr(CheckableFunc148d6054.instance, arg);
  }
  ...
  public static Void collapsible(boolean arg) {
    return DSL.attr(CollapsibleFunc148d6054.instance, arg);
  }

  public static Void defaultActionButtonContentDescription(int arg) {
    return DSL.attr(DefaultActionButtonContentDescriptionFunc8567756a.instance, arg);
  }
  ...
  public static Void expandActivityOverflowButtonContentDescription(int arg) {
    return DSL.attr(ExpandActivityOverflowButtonContentDescriptionFunc8567756a.instance, arg);
  }

  public static Void expandActivityOverflowButtonDrawable(Drawable arg) {
    return DSL.attr(ExpandActivityOverflowButtonDrawableFuncfb47464a.instance, arg);
  }

  public static Void expandedActionViewsExclusive(boolean arg) {
    return DSL.attr(ExpandedActionViewsExclusiveFunc148d6054.instance, arg);
  }

  public static Void forceShowIcon(boolean arg) {
    return DSL.attr(ForceShowIconFunc148d6054.instance, arg);
  }
  ...
  public static Void icon(Drawable arg) {
    return DSL.attr(IconFuncfb47464a.instance, arg);
  }
  ...
  public static Void initialActivityCount(int arg) {
    return DSL.attr(InitialActivityCountFunc8567756a.instance, arg);
  }
  ...
  public static Void logo(Drawable arg) {
    return DSL.attr(LogoFuncfb47464a.instance, arg);
  }

  public static Void logo(int arg) {
    return DSL.attr(LogoFunc8567756a.instance, arg);
  }

  public static Void logoDescription(int arg) {
    return DSL.attr(LogoDescriptionFunc8567756a.instance, arg);
  }

  public static Void logoDescription(CharSequence arg) {
    return DSL.attr(LogoDescriptionFuncc0af808b.instance, arg);
  }
  ...
  public static Void navigationContentDescription(int arg) {
    return DSL.attr(NavigationContentDescriptionFunc8567756a.instance, arg);
  }

  public static Void navigationContentDescription(CharSequence arg) {
    return DSL.attr(NavigationContentDescriptionFuncc0af808b.instance, arg);
  }

  public static Void navigationIcon(Drawable arg) {
    return DSL.attr(NavigationIconFuncfb47464a.instance, arg);
  }

  public static Void navigationIcon(int arg) {
    return DSL.attr(NavigationIconFunc8567756a.instance, arg);
  }

  public static Void navigationOnClickListener(View.OnClickListener arg) {
    return DSL.attr(NavigationOnClickListenerFunc79a13a5e.instance, arg);
  }

  public static Void onDismiss(PopupWindow.OnDismissListener arg) {
    return DSL.attr(OnDismissFunc6b0eb982.instance, arg);
  }

  public static Void onFitSystemWindows(FitWindowsViewGroup.OnFitSystemWindowsListener arg) {
    return DSL.attr(OnFitSystemWindowsFuncad8dd5d7.instance, arg);
  }

  public static Void onInflate(ViewStubCompat.OnInflateListener arg) {
    return DSL.attr(OnInflateFuncb0ac3dfe.instance, arg);
  }

  public static Void onMenuItemClick(ActionMenuView.OnMenuItemClickListener arg) {
    return DSL.attr(OnMenuItemClickFuncd1d929f2.instance, arg);
  }

  public static Void onMenuItemClick(Toolbar.OnMenuItemClickListener arg) {
    return DSL.attr(OnMenuItemClickFunc68ab335d.instance, arg);
  }
  ...
  public static Void overflowIcon(Drawable arg) {
    return DSL.attr(OverflowIconFuncfb47464a.instance, arg);
  }

  public static Void overflowReserved(boolean arg) {
    return DSL.attr(OverflowReservedFunc148d6054.instance, arg);
  }

  public static Void popupTheme(int arg) {
    return DSL.attr(PopupThemeFunc8567756a.instance, arg);
  }

  public static Void primaryBackground(Drawable arg) {
    return DSL.attr(PrimaryBackgroundFuncfb47464a.instance, arg);
  }

  public static Void provider(ActionProvider arg) {
    return DSL.attr(ProviderFunc66da8dbe.instance, arg);
  }
  ...
  public static Void showText(boolean arg) {
    return DSL.attr(ShowTextFunc148d6054.instance, arg);
  }

  public static Void splitBackground(Drawable arg) {
    return DSL.attr(SplitBackgroundFuncfb47464a.instance, arg);
  }

  public static Void splitTrack(boolean arg) {
    return DSL.attr(SplitTrackFunc148d6054.instance, arg);
  }

  public static Void stackedBackground(Drawable arg) {
    return DSL.attr(StackedBackgroundFuncfb47464a.instance, arg);
  }

  public static Void subtitle(int arg) {
    return DSL.attr(SubtitleFunc8567756a.instance, arg);
  }

  public static Void subtitle(CharSequence arg) {
    return DSL.attr(SubtitleFuncc0af808b.instance, arg);
  }

  public static Void subtitleTextColor(int arg) {
    return DSL.attr(SubtitleTextColorFunc8567756a.instance, arg);
  }
  ...
  public static Void title(int arg) {
    return DSL.attr(TitleFunc8567756a.instance, arg);
  }

  public static Void title(CharSequence arg) {
    return DSL.attr(TitleFuncc0af808b.instance, arg);
  }

  public static Void titleTextColor(int arg) {
    return DSL.attr(TitleTextColorFunc8567756a.instance, arg);
  }
  ...
  private static final class ActivityChooserModelFunc5cb66d58 implements Anvil.AttrFunc<ActivityChooserModel> {
    public static final ActivityChooserModelFunc5cb66d58 instance = new ActivityChooserModelFunc5cb66d58();

    public void apply(View v, final ActivityChooserModel arg, final ActivityChooserModel old) {
      if (v instanceof ActivityChooserView) {
        ((ActivityChooserView) v).setActivityChooserModel(arg);
      }
    }
  }
