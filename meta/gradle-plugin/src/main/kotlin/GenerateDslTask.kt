...
abstract class GenerateDslTask : DefaultTask() {
    ...
    fun renderModel() {
        ...
        val setterObject = buildObject(ClassName(model.packageName, "${model.name}Setter")) {
            addKdoc(
        ...
        model.views.forEach { view ->
            ...
            fileSpec.addFunction(viewName.lowerFirstChar()) {
                addParameter(
                    "configure",
        ...
        fileSpec
            ...
            .addAnnotation(Suppress::class.asClassName()) {
